...
- 1. 과제에서 모호하거나 애매했던 부분
    1) JUnit 사용 및 Mockito 사용 방법이 다양한듯 한데, 이게 올바른 방식인지 ? or 자주 사용되는 방식인지 잘 모르겠습니다.
    2) 심화 과제를 시도해보지 못했습니다.
...
- 3. 구현 과정에서의 기술적 도전과 해결
    1) JUnit과 Mockito 라이브러리를 사용해본적이 없고, 테스트 코드를 TDD 개념으로 작성해본적이 없었어서 좋은 경험이 되었다고 생각합니다.
-->
